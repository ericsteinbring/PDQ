function queryvizier_cadc, catalog, target, dis, VERBOSE=verbose, CFA=CFA,  $
...
;
; PURPOSE: 
;   Query any catalog in the Vizier database by position, hardwired to use CADC
; 
; EXPLANATION:
